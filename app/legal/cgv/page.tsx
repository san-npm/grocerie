...
const content: Record<string, { title: string; sections: { heading: string; body: string }[] }> = {
  fr: {
    ...
    sections: [
      ...
      { heading: "7. Livraison", body: "Livraison disponible au Luxembourg, en France, Belgique et Allemagne via POST Luxembourg. Les frais de port dépendent du poids et de la destination (à partir de 7 € au Luxembourg, 12 € en Zone 1 Europe). Retrait en boutique (Click & Collect) gratuit au 12 Rue Münster à Grund. Délai de livraison estimé : 1 à 7 jours ouvrables." },
  ...
  en: {
    ...
    sections: [
      ...
      { heading: "7. Delivery", body: "Delivery available in Luxembourg, France, Belgium and Germany via POST Luxembourg. Shipping fees depend on weight and destination (from €7 in Luxembourg, €12 in Europe Zone 1). In-store pickup (Click & Collect) is free at 12 Rue Münster in Grund. Estimated delivery: 1–7 business days." },
