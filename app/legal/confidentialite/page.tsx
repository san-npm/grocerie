...
const content: Record<string, { title: string; sections: { heading: string; body: string }[] }> = {
  fr: {
    ...
    sections: [
      ...
      { heading: "6. Sous-traitants", body: "Stripe (paiement), Vercel (hébergement), Resend (e-mails transactionnels), POST Luxembourg (livraison). Ces prestataires sont conformes au RGPD." },
  ...
  en: {
    ...
    sections: [
      ...
      { heading: "6. Subprocessors", body: "Stripe (payments), Vercel (hosting), Resend (transactional emails), POST Luxembourg (delivery). These providers are GDPR compliant." },
  ...
  return (
    <main className="relative z-[1] pt-32 pb-24 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-xs text-warmgray/50 mt-12">Dernière mise à jour / Last updated: 17 avril 2026</p>
      </div>
    </main>
  );
}
