...
const content: Record<string, { title: string; sections: { heading: string; body: string }[] }> = {
  fr: {
    ...
    sections: [
      ...
      { heading: "3. Procédure", body: "Pour initier un retour, contactez-nous à info@lagrocerie.lu en indiquant votre numéro de commande. Nous vous fournirons les instructions de retour. Les frais de retour sont à la charge du client." },
      ...
      { heading: "6. Click & Collect", body: "Pour les commandes retirées en boutique, vous pouvez retourner les produits directement au magasin au 12 Rue Münster, dans les mêmes conditions (non ouverts, emballage d'origine) dans un délai de 14 jours." },
    ],
  },
  en: {
    title: "Refund Policy",
    sections: [
      ...
      { heading: "3. Procedure", body: "To initiate a return, contact us at info@lagrocerie.lu with your order number. We will provide return instructions. Return shipping costs are borne by the customer." },
      ...
      { heading: "6. Click & Collect", body: "For orders picked up in store at 12 Rue Münster, you can return products directly to the shop under the same conditions (unopened, original packaging) within 14 days." },
    ],
  },
};
