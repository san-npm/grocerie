...
const L: Record<Locale, {
  ...
  fr: {
    ...
    delivery: "Livraison",
    deliveryDesc: "POST Luxembourg · LU, FR, DE, BE",
    ...
    shippingHint: "Tarifs POST Luxembourg : dès 12€ (selon poids)",
    total: "Total",
  ...
  en: {
    ...
    shippingHint: "POST Luxembourg rates: from €12 (by weight)",
    total: "Total",
  ...
  de: {
    ...
    shipping: "Versand",
    free: "Kostenlos",
    calculated: "Wird bei der Zahlung berechnet",
    shippingHint: "POST Luxembourg Tarife: ab 12€ (je nach Gewicht)",
    total: "Gesamt",
  ...
  lb: {
    ...
    shipping: "Versand",
    free: "Gratis",
    calculated: "Beim Bezuelen berechent",
    shippingHint: "POST Luxembourg Tariffer: vun 12€ (no Gewiicht)",
    total: "Total",
    plusShipping: " + Versand",
              ...
              <div className="border-t border-ink/5 pt-4 space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-warmgray">
                    {deliveryMethod === "pickup" ? l.free : l.calculated}
                  </span>
                </div>
                {deliveryMethod === "delivery" && (
                  <p className="text-xs text-warmgray/50">{l.shippingHint}</p>
                )}
                <div className="flex justify-between text-lg font-playfair pt-2 border-t border-ink/5">
                  <span>{l.total}</span>
                  <span>
                    {totalPrice.toFixed(2)}€{deliveryMethod === "delivery" ? l.plusShipping : ""}
                  </span>
                </div>
