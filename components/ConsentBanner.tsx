...
const STORAGE_KEY = "gr-consent-v2";
      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6">
        ...
        <div className="flex gap-3 flex-shrink-0">
          ...
          <button
            ...
            className="text-[11px] tracking-luxury uppercase px-4 py-2 bg-mustard text-ink hover:bg-mustard-dark hover:text-cream transition-colors"
          >
            {t("consent.accept")}
          </button>
        </div>
