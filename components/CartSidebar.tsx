...
export default function CartSidebar() {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 right-0 h-full w-full max-w-md bg-cream z-[80] animate-slide-in-right flex flex-col">
              ...
              {items.map((item) => (
                <div key={item.wine.id} className="flex gap-3 border-b border-ink/5 pb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-warmgray">{item.wine.priceShop}€</p>
                    <div className="flex items-center gap-2 mt-2">
                      ...
                      <button
                        ...
                        className="ml-auto text-[10px] text-warmgray hover:text-wine"
                      >
                        ✕
                      </button>
                    </div>
